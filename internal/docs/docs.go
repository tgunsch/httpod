        ...
        "/proxy": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Method to use for the backend request. Defaults to 'GET'.",
                        "name": "method",
                        "in": "header"
                    },
                    {
                        "type": "string",
                        "description": "URL to use for the backend request.",
                        "name": "url",
                        "in": "header"
                    },
                    {
                        "type": "string",
                        "description": "Body to use for a POST request.",
                        "name": "body",
                        "in": "header"
                    },
                    {
                        "type": "string",
                        "description": "JSON of headers to add to the backend request.",
